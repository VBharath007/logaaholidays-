...
// The Karnataka packages with their starting city
...
const enrichedPackages = karnatakaPackages
  ...
  .map((p) => {
    ...
    return {
      ...p,
      title: db.title || '',
      image: db.image || '/assets/karnataka1.webp',
      heroImage: db.heroImage || '/assets/karnataka4.webp',
...
export function KarnatakaTourPackages() {
  useSEO(
    'Karnataka Tour Packages | Best Karnataka Holiday Packages | Logaa Holidays',
    'Explore the best Karnataka tour packages covering Mysore, Coorg, Ooty, Bangalore and more. Book your Karnataka holiday with Logaa Holidays.',
    'Karnataka tour packages, Karnataka holiday packages, Mysore tour package, Coorg package, Karnataka honeymoon tour, Logaa Holidays Karnataka'
  );
      ...
      <div className="relative w-full h-[500px] sm:h-[600px] overflow-hidden rounded-b-[40px] shadow-[0_20px_50px_rgba(0,0,0,0.12)]">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 pt-32 h-full flex flex-col items-center text-center">
          <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-md px-4 py-2 rounded-full mb-5 border border-white/30">
            ...
            <span className="text-sm font-semibold text-white tracking-wide">Logaa Holidays — Karnataka Specialists</span>
          </div>
          ...
          <p className="text-lg md:text-xl text-white/90 max-w-2xl mb-8 leading-relaxed drop-shadow">
            Royal Palaces · Misty Hills · Coffee Estates · Heritage Temples
            <br />
            <span className="text-sm font-medium text-white/70">Bangalore → Mysore → Coorg → Ooty → Hampi</span>
          </p>
          ...
          <div className="flex flex-wrap gap-3 justify-center">
            ...
            <div className="bg-white/20 backdrop-blur-md border border-white/30 rounded-2xl px-5 py-3 text-white text-sm font-semibold flex items-center gap-2">
              <MapPin className="w-4 h-4" /> Starts from Bangalore / Mysore
            </div>
            <div className="bg-white/20 backdrop-blur-md border border-white/30 rounded-2xl px-5 py-3 text-white text-sm font-semibold flex items-center gap-2">
              <Users className="w-4 h-4" /> Family · Honeymoon · Heritage
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-2xl font-bold text-slate-800">
              {activeCity === 'All' ? 'All Karnataka Tour Packages' : `Packages Starting from ${activeCity}`}
            </h2>
          </div>
        ...
        <div className="bg-white rounded-[2.5rem] p-8 md:p-10 shadow-sm border border-slate-100">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              { icon: <Star className="w-6 h-6" />, title: 'Handpicked Hotels', desc: 'Carefully selected stays for a comfortable and memorable experience.' },
            ].map((item, i) => (
      ...
      <div className="max-w-7xl mx-auto px-6 mb-8">
        <div className="bg-[var(--color-primary-forest)] rounded-3xl p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-6 relative overflow-hidden">
          ...
          <div className="relative z-10">
            <h3 className="text-2xl md:text-3xl font-bold text-white mb-2">Plan Your Karnataka Journey</h3>
            <p className="text-white/80 text-sm max-w-md">
              Palaces, hills, wildlife, and temples — all in one trip. Call or WhatsApp us to customise your perfect Karnataka tour.
            </p>
          </div>
          <a
